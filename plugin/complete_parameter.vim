...
augroup cp_in
    ...
    au FileType go inoremap <m-p> <ESC>:call complete_parameter#goto_previous_param()<cr>
    au FileType go nnoremap <m-p> <ESC>:call complete_parameter#goto_previous_param()<cr>
    au FileType go xnoremap <m-p> <ESC>:call complete_parameter#goto_previous_param()<cr>
    au FileType go vnoremap <m-p> <ESC>:call complete_parameter#goto_previous_param()<cr>
augroup END
